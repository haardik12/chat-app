...
const { ConvoModel , MessageModel } = require('../models/messageModel');
...
io.on('connection', async (socket) => {
  ...
  socket.on('new message', async (data) => {
    ...
    const updateConversation = await ConvoModel.updateOne({ _id : conversation?._id }, { "$push" : { messages : saveMessage?._id }})
  ...
  socket.on('sidebar', async (currentUserId) => {
            ...
            const conversationSidebar = await getConversation(
              currentUserId
            )
